        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Project Details Form</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-9">
            ...
            <div class="card card-primary">
              ...
              <form role="form" action="project details.php" method="POST" onsubmit="return validation()" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label>Project Name</label>
                    <input type="text" class="form-control" id="mname" name="Name" placeholder="Project Name">
                  </div>
                  <div class="form-group">
                    <label>Project Modules</label>
                    <input type="text" class="form-control" id="mname" name="Name" placeholder="Project Modules">
                  </div>
                 
                  <div class="form-group">
                    <label>Project Description</label>
                    <input type="text" name="address"  id="add" class="form-control" placeholder="Project Description">
                  </div>
